// PrintEtiketka.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPrintEtiketkaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CPrintEtiketkaApp

CPrintEtiketkaApp::CPrintEtiketkaApp()
{
...
// Единственный объект CPrintEtiketkaApp

CPrintEtiketkaApp theApp;


// инициализация CPrintEtiketkaApp

BOOL CPrintEtiketkaApp::InitInstance()
{
